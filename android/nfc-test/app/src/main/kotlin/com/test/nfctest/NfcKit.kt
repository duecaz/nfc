...
object NfcKit {
    ...
    private fun readCardId(): String {
        return try {
            ...
            Log.e(TAG, "readCardId error: ${e.message}")
            "ERR"
        }
    }
}
